...
public class SynthGroups {
	...
	/**
	 * pointer to com.papaworx.gs_lv.GS_Application logger
	 */
	 ...
	 * @param _logger  com.papaworx.gs_lv.GS_Application logger
	...
	private void saveDataFile(int _iLineCount, String _sFileName, Double[][] _DarData, String[] _sarCarriageReturns) {
		...
		String sHeader = null;
		/*
		 * the 'Lehmer signer' is initialized (see com.papaworx.gs_lv.utilities..Lehmer), to make
