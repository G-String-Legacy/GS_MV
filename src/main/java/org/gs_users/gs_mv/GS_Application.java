...
public class GS_Application extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        /*
          String containing current location of log file output.
         */
        String sLogPath = sHomeDir + File.separator + "org.gs_users.gs_vl.Log";
        ...
        logger = Logger.getLogger(org.gs_users.gs_mv.GS_Application.class.getName());
    ...
    public void doSetup() {
        ...
        org.gs_users.gs_mv.steps.GSetup setup = new org.gs_users.gs_mv.steps.GSetup(primaryStage, logger, prefs);
        try {
            setup.ask();
        } catch (IOException e) {
            logger.warning(e.getMessage());
