...
import org.gs_users.gs_mv.utilities.*;
...
public class SynthGroups {
	 ...
	 */
	public SynthGroups(org.gs_users.gs_mv.GS_Application _main, Nest _nest, Logger _logger, org.gs_users.gs_mv.GS_Controller _controller, Preferences _prefs, Filer _flr) {
		myMain = _main;
		myNest = _nest;
